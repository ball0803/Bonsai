...
function Search() {
  ...
  useEffect(() => {
    fetch(
      `https://firestore.googleapis.com/v1/projects/bonsai-c2608/databases/(default)/documents/Fundimental/${query.get("q") || 'ICN'}?key=AIzaSyAQfPN3u3W01Whz6qi8fYXuTadDFKbKR2w`
    )
  ...
  return (
    <div>
      <Typography component="div" theme={theme}>
        ...
        { 
          query.get("q") ?
            <div><form onSubmit={submitAction} className='searchbar-first'>
          ...
          <Box className="stock-title">{query.get("q")}</Box>
