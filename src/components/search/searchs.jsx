...
import { getFirestore, doc, onSnapshot, collection, query, where, getDocs, limit, orderBy } from "firebase/firestore";
...
function Search() {
  ...
  //     console.log(snapshot.docs.map((doc)=>{console.log(doc)}))
  //   })
  // }, [])
